...
const (
	URLShortener_ShortURL_FullMethodName = "/URLShorter.URLShortener/ShortURL"
	URLShortener_GetURL_FullMethodName   = "/URLShorter.URLShortener/GetURL"
)
...
func (c *uRLShortenerClient) ShortURL(ctx context.Context, in *ShortURLRequest, opts ...grpc.CallOption) (*ShortURLResponse, error) {
	...
	err := c.cc.Invoke(ctx, URLShortener_ShortURL_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var URLShortener_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "URLShorter.URLShortener",
